...
import com.denizenscript.clientizen.mixin.IntegerPropertyAccessor;
...
public abstract class MaterialIntProperty extends MaterialMinecraftProperty<IntegerProperty, Integer> {
    ...
    public IntegerPropertyAccessor getAccessor() {
        return (IntegerPropertyAccessor) (Object) internalProperty;
    }
    ...
    public void setPropertyValue(ElementTag value, Mechanism mechanism) {
        ...
        IntegerPropertyAccessor accessor = getAccessor();
